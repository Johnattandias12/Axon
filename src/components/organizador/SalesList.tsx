    ...
    <div className="space-y-3">
        ...
        {initialOrders.slice(0, 50).map((o) => {
          ...
          return (
            <button
              ...
              className="flex w-full items-center gap-3 rounded-xl border p-3 text-left transition-all hover:scale-[1.01] hover:border-white/20 focus:ring-1 focus:ring-white/20 focus:outline-none active:scale-[0.99]"
      ...
      <Dialog open={!!selectedOrder} onOpenChange={(open) => !open && setSelectedOrder(null)}>
        <DialogContent className="max-w-xl border-neutral-800 bg-neutral-950 p-6 text-white backdrop-blur-xl">
          {selectedOrder &&
            (() => {
              const evt = Array.isArray(selectedOrder.events)
                ? selectedOrder.events[0]
                ...
                <>
                  <DialogHeader className="border-b border-neutral-900 pb-4">
                    ...
                    <div className="mt-2 flex items-center gap-1.5 text-xs text-neutral-300">
                      ...
                      <span className="font-mono text-white selection:bg-neutral-800">
                        {selectedOrder.id}
                      </span>
                      <button
                        type="button"
                        onClick={() => handleCopy("order-id", selectedOrder.id)}
                        className="ml-1 rounded-md p-1 text-neutral-500 transition-colors hover:bg-neutral-900 hover:text-white"
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="flex justify-between">
                          ...
                          <span className="font-mono font-medium">
                            {centsToBRL(selectedOrder.subtotal_cents)}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          ...
                          tickets.map((t) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="absolute top-1/2 -left-2 h-4 w-4 -translate-y-1/2 rounded-full border-r border-neutral-900 bg-neutral-950" />
                                <div className="absolute top-1/2 -right-2 h-4 w-4 -translate-y-1/2 rounded-full border-l border-neutral-900 bg-neutral-950" />
