  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="fixed right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-transform hover:scale-110 active:scale-95 sm:right-6"
        style={{
          backgroundColor: "#25D366",
          // safe-area-inset-bottom pra iPhones com notch + valor base
